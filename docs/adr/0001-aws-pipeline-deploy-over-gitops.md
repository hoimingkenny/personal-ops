...
**Why:** Matches day-to-day AWS-centric service shipping; keeps the story in `.github/workflows/` + Terraform; still shows OIDC, SHA-tagged images, Trivy, Secrets Manager, readiness probes.
