...
| [`.scratch/personal-ops-os/spec.md`](../../.scratch/personal-ops-os/spec.md) | **Active build spec** — created by `/to-spec`; drives tickets and `/implement` |
...
The original `personal-ops-dashboard-spec_1.md` (Dashboard-era brainstorm) was deleted — decisions live in **ADRs** and **CONTEXT**; implementation detail will live in **`.scratch/personal-ops-os/spec.md`** after `/to-spec`.
